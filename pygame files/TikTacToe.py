...
HEIGHT = 600
colors={"white":(255,255,255),"pink":(255,0,255),"blue":(0,0,255),"limeGreen":(153,255,51), "iron": (218, 223, 225),
"RED" : (255, 0, 0),
"GREEN" : (0, 255, 0),
"BLUE" : (0, 0,255),
# SHADES,
...
celly=0
player=1
circle_color=colors.get("GREEN_1")
x_color=colors.get("RED_1")
...
def draw_markers():
    ...
    for x in markers: #give me each row of list
        ...
        for y in x: #give each element
            if y==1:
                # draw x
                pygame.draw.line(screen, x_color, (xvalue*WIDTH//size+15, yvalue*HEIGHT//size+15), (xvalue*WIDTH//size+WIDTH//size-15, yvalue*HEIGHT//size+HEIGHT//size-15), lineWidth)
                pygame.draw.line(screen, x_color, (xvalue*WIDTH//size+WIDTH//size-15, yvalue*HEIGHT//size+15), (xvalue*WIDTH//size+15, yvalue*HEIGHT//size+HEIGHT//size-15), lineWidth)
            if y==-1:
                #draw o
                pygame.draw.circle(screen, circle_color, (xvalue*WIDTH//size+WIDTH//(2*size)+5, yvalue*HEIGHT//size+HEIGHT//(2*size)+5), WIDTH//(2*size)-lineWidth-10, lineWidth)
            yvalue+=1
        xvalue+=1
...
def again():
    ...
    screen.blit(text_yes, (WIDTH//4-20, HEIGHT//2-45))
    screen.blit(text_no, (3*WIDTH//4-15, HEIGHT//2-45))
    pygame.display.update()
